...
namespace CRUD_ASP_SP
{
    public partial class _Default : Page
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source = ANSAR\SQLEXPRESS; Initial Catalog = crud_asp_sp; Integrated Security = True");
        //SqlConnection con = new SqlConnection(@"Server=sql.bsite.net\MSSQL2016;Database=naimansary_;User Id=naimansary_;password=Allah@@@---1");
